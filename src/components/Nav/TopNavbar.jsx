    ...
    <>
      ...
      <Wrapper className="flexCenter animate whiteBg" style={y > 100 ? { height: "80px" } : { height: "80px" }}>
        <NavInner className="container flexSpaceCenter">
          ...
          <UlWrapperRight className="flexNullCenter mb-0" style={{ fontWeight: "600" }}>
            <div className="flexNullCenter d-lg-flex  d-block align-items-center my-lg-0  my-3" style={{ fontWeight: "600" }}>
